      ...
      <body className="bg-gray-900 text-white">
        <header className="w-full px-6 py-6 flex justify-between items-center bg-gradient-to-b from-gray-900/80 to-transparent">
          ...
          <Link href="/auth/login">
            <a className="px-6 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-full shadow-lg transition">Login</a>
          </Link>
        </header>
        ...
        <footer className="bg-gray-900 text-center md:text-left px-6 py-12 mt-12">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-6">
              <a href="https://www.instagram.com/dsrt.official.2025" target="_blank" className="text-white hover:text-pink-500 transition">Instagram</a>
              <a href="https://github.com/mydsrt-artweb/sds" target="_blank" className="text-white hover:text-gray-400 transition">Github</a>
            </div>
          </div>
